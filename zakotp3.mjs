#!/usr/bin/env node
/* ZakTracking - say WHY a one-time code did not go out.
 *
 * One file changes: app/lib/otp.server.ts
 *   - the provider's own error is now handed back to the form, under the
 *     friendly line, so a failure can be read instead of guessed at
 *   - a WhatsApp template name is folded to what Meta actually accepts
...
const FILES = [
  {
    ...
    "fromShas": [
      ...
      "1a091d46544cc210bfb0deada86ebf84b820fb0bd1c01678d4955e4231d77ef8"
    ],
    "toSha": "1a091d46544cc210bfb0deada86ebf84b820fb0bd1c01678d4955e4231d77ef8",
